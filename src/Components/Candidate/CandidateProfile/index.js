        ...
        <Grid item xs={12}>
          {
            ...
            (
              <div spacing={3}>
                <Button variant='contained' onClick={saveInfo} type="submit">Save</Button>
                <Button variant='contained' onClick={() => setEdit(false)} type="submit">Cancel</Button>
              </div>
            ) : 
            (
              <Button variant='contained' onClick={() => setEdit(true)} type="submit">Edit</Button>
            )
          }
